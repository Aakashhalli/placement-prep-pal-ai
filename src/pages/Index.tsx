...
const Index = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Natural voice-based conversations for a more immersive experience",
    },
    {
    ...
    },
    {
      ...
      description:
        "Practice interviews across various CS domains including DSA, DBMS, OS, and more",
    },
    {
      title: "Customizable Difficulty",
      description:
        "Choose your preferred difficulty level to match your preparation stage",
    },
    {
          ...
          <div className="w-full md:w-3/5 flex flex-col items-center animate-slide-right">
            <div className="text-center mb-10">
              ...
              <p className="text-light-muted text-lg max-w-2xl mx-auto">
                Practice with AI-powered interviews tailored to your preferences
                and get instant feedback to improve your skills.
              </p>
            </div>
