...
export const TopicCard = ({ topic }: TopicCardProps) => {
  ...
  return (
    <motion.div
      className={`
        bg-gray-600 rounded-xl overflow-hidden shadow-lg hover:shadow-xl
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center">
            ...
            <h3 className="text-xl font-semibold text-custom-darkBlue1">
              {topic.name}
            </h3>
          </div>
          {topic.score > 0 && (
            <div className="bg-custom-gold/10 px-3 py-1 rounded-full">
              <span className="text-custom-gold font-medium">
                {topic.score}%
              </span>
            </div>
          )}
        ...
        <p className="text-black mb-4">{topic.description}</p>
