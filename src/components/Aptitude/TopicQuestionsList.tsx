...
const TopicQuestionsList = ({ topicId }: TopicQuestionsListProps) => {
    ...
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center">
        ...
        <p className="text-gray-500">
          We're still working on questions for this topic. Check back soon!
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-2xl font-bold text-custom-darkBlue1 mb-6">
        Practice Questions
      </h2>
      ...
      {questions.map((question, index) => (
        <Card
          key={question.id}
          className="p-6  border-none hover:shadow-lg transition-shadow"
        >
          <div className="pb-6">
            <div className="flex items-start ">
              <div className="bg-green-100 text-black font-normal rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                {index + 1}
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              {question.options.map((option, optIndex) => {
                ...
                const isCorrect =
                  showAnswers[question.id] && option === question.correctAnswer;
                const isIncorrect =
                ...
                return (
                  <button
                    ...
                    className={`
                      flex items-start p-4 rounded-lg border-2 text-left transition-all duration-200 text-black
                      ${
                        isSelected
