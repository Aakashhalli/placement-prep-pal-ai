...
const Sidebar = ({
  ...
  const progressPercentage =
    (userProgress.topicsCompleted / userProgress.totalTopics) * 100;
  ...
  return (
    <div
      className={cn(
        "bg-sidebar flex flex-col transition-all duration-300 sticky top-16 z-20 bg-custom-darkBlue1 text-white",
    ...
    >
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute top-1 right-6 text-white hover:text-custom-gold focus:outline-none"
      ...
      {/* <div
        className={cn(
          "px-1 py-6 flex flex-col items-center",
      ...
      {!isSidebarCollapsed && (
        <div className="px-3 py-2 mt-10">
          <Input
            ...
            className="bg-custom-darkBlue2 border-custom-gold/30 text-black placeholder:text-gray-400"
          />
        </div>
      )}
