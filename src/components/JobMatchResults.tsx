      ...
      <Tabs defaultValue="profile" className="w-full">
        ...
        <TabsContent value="profile" className="space-y-6">
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <p className="text-lg text-white pl-6">{location || "Remote"}</p>
          </div>
        ...
        <TabsContent value="personality" className="space-y-6">
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-zinc-400">
              Understanding your strengths & potential
            </p>
          </div>
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="space-y-3 pl-6">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-3">
                  <Progress
                    value={growthPotential.score * 10}
                    className="h-2 bg-zinc-800"
                  />
                  <span className="text-xs text-zinc-400">
                    {growthPotential.score}/10
                  </span>
                </div>
              </div>

              {growthPotential.indicators &&
              growthPotential.indicators.length > 0 ? (
                <div className="mt-2">
                  <h5 className="text-xs text-zinc-500 mb-2">
                    Growth Indicators
                  </h5>
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.3s" }}>
            ...
            <div className="pl-6 space-y-3">
              <p className="text-sm text-zinc-300">
                Based on your experience, skills, and interests, you appear to
                be a good fit for{" "}
              ...
              {interests && interests.length > 0 && (
                <p className="text-sm text-zinc-300">
                  Your resume shows the strongest passion for{" "}
                  <span className="text-white font-medium capitalize">
                    {interests[0]?.skill}
                  </span>
                  , which suggests you would thrive in roles focused on this
                  technology.
                </p>
              )}
              {growthPotential.score > 5 && (
                <p className="text-sm text-zinc-300">
                  Your growth mindset indicates you're likely to excel in
                  dynamic environments that offer professional development
                  opportunities.
                </p>
              )}
            </div>
        ...
        <TabsContent value="suggestions" className="space-y-6">
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-zinc-400">
              Suggestions to enhance your profile
            </p>
          </div>
            ...
            <div className="space-y-4 pl-2">
              {resumeSuggestions && resumeSuggestions.length > 0 ? (
                resumeSuggestions.map((suggestion, index) => (
                  <div
                    key={index}
                    className="flex gap-3 items-start p-3 rounded-lg bg-zinc-800/30 border border-zinc-700/30"
                  >
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="space-y-3 pl-6">
              <p className="text-sm text-zinc-300">
                ...
                roles, consider highlighting:
              </p>
              <ul className="list-disc pl-5 space-y-2 text-sm text-zinc-300">
                <li>
                  Specific metrics and achievements that demonstrate your impact
                </li>
                <li>
                  Collaborative projects that showcase your teamwork abilities
                </li>
                <li>
                  Problem-solving examples that illustrate your approach to
                  challenges
                </li>
                <li>
                  Continuous learning efforts such as certifications or courses
                </li>
              </ul>
            </div>
          </div>
